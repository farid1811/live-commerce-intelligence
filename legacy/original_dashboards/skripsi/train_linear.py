...
for epoch in range(1, max_epoch+1):
    ...
    if delta < tolerance:
        print(f"Konvergen di iterasi {epoch}")
        break
...
print(f"Koef Durasi: {theta_original[0]}")
print(f"Koef Penonton: {theta_original[1]}")
print(f"Intercept: {bias_original}")
...
joblib.dump(model_data, "model_linear.pkl")

print("\nModel berhasil disimpan → model_linear.pkl")
